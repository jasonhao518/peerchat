...
build-windows:
	...
	@CGO_ENABLED=1  CC=x86_64-w64-mingw32-gcc GOOS=windows GOARCH=amd64 go build -o ./bin/peerchat-windows-x64.exe ./cmd/*
...
build-linux:
	...
	@CGO_ENABLED=1 CC=x86_64-linux-gnu-gcc GOOS=linux GOARCH=amd64 go build -o ./bin/peerchat-linux-x64 ./cmd/*
	@echo Cross Compiling PeerChat for Linux Arm64
	@CGO_ENABLED=1 CC=x86_64-linux-gnu-gcc GOOS=linux GOARCH=arm64 go build -o ./bin/peerchat-linux-arm64 ./cmd/*
